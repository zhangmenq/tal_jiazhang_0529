<template>
  <div class="import_container" v-if="status == 1">
    <img
      src="../../assets/import/py_banner.png"
      v-if="channel_number == 23"
      class="import_banner"
    />
    <img src="../../assets/import/bannerB.png" v-else class="import_banner" />
    <div class="import_con">
      <!--登录-->
      <div class="import_login" style="margin-top:.3rem">
        <img
          src="../../assets/import/winter_t.png"
          v-if="channel_number == 23"
          class="title"
        />
        <img src="../../assets/import/titleB.png" v-else :class="{title: fromType == 1,titleB:fromType == 2}"/>
        <p class="sub_title" v-show="fromType == 1">— 点击按钮 选择年级 —</p>
        <p class="sub_title" v-show="fromType == 2" v-if="channel_number == 23">
          — 美国小学英语全能力诊断 —
        </p>
        <!--选年级-->
        ...
        <div class="import_login_box" v-show="fromType == 2">
          ...
          <div class="item item_btn_box">
            <a
              href="javascript:;"
              class="import_login_btn"
              @click="test"
              v-if="channel_number == 23"
              >0元试听 抢占名额</a
            >
            <a href="javascript:;" class="import_login_btn" @click="test" v-else
              >立即诊断</a
            >
          </div>
        </div>
      ...
      <div class="planc_info_box">
        ...
        <div class="about_vipx">
          学而思VIPX是学而思旗下在线外教品牌。学而思VIPX秉承学而思15年对教学品质与服务的严格要求，专注为全国5-14岁中国孩子提供最优质的在线北美外教课程，学而思VIPX将始终秉承着“纯正美式课堂，把世界带进我家“的教育理念，让孩子成为具备双语能力，融知识、思维和价值观于一体的新时代未来公民。
        </div>
      </div>
    </div>
    <!--footer_btn-->
...
export default {
  ...
  computed: {
    channel_number() {
      return Number(this.$route.params.channel_id);
    }
  },
  methods: {
    //选择答题选项
...
.import_con {
  ...
  .import_login {
    ...
    box-shadow: 0 0.08rem 0.19rem 0.02rem rgba(149, 51, 0, 0.27);
